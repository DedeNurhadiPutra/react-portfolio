...
const About = () => {
  return (
    <div className="h-screen py-10 md:py-14">
      <h5 className="text-center llg:text-xs">Get To Know</h5>
      <h2 className="text-center font-medium llg:text-xl">About Me </h2>

      <div className="w-full grid grid-cols-1 gap-16 mt-10 md:pt-6 llg:grid-cols-2 llg:gap-0 llg:w-[90%] llg:mx-auto">
        <div className="w-2/3 aspect-square rounded-3xl bg-gradient-to-b from-violet-900 mx-auto md:w-72 llg:w-72">
          <img
            src={Me}
            alt="About Me"
        ...
        <div className="w-[90%] mx-auto mt-0 text-center">
          ...
          <p className="text-justify py-2 md:pt-10 md:pb-8 llg:py-6">
